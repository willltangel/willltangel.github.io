...
<main>
    ...
    <div id="myModal" class="modal">
        <div class="modal-content">
            <table>
                <tD id="tableimg">
                    <img src="../img/panpng.png" alt="" style="width: 140px;">
                </td>
                <td id="tablespan">

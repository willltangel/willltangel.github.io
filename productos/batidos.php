...
<main>
    ...
    <section class="gallery" style="margin-top: 50px;">
        ...
        <div>
            ...
            <img src="../img/bbananaymiel.jfif" alt="Café 8" class="cafe-img"
    ...
    <div id="myModal" class="modal">
        <div class="modal-content">
            <table>
                <tD id="tableimg">
                    <img src="../img/batidopng.png" alt="" style="width: 140px;">
                </td>
                <td id="tablespan">

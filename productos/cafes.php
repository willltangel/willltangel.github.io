...
<main>
    ...
    <section class="gallery" style="margin-top: 10%;">
        ...
        <div>
            ...
            <img src="../img/cafepng.png" alt="Café 8" class="cafe-imgc"
                onclick="openModal('Café 8', 'Irish Coffee', '5.00', 'El Irish coffee es un café con whisky y crema, ideal para una noche especial.')">
            <img src="../img/cafepng.png" alt="Café 9" class="cafe-imgc"
                onclick="openModal('Café 9', 'Affogato', '4.25', 'El affogato es una bola de helado bañada con espresso caliente.')">
        </div>
        <div>
            <img src="../img/cafepng.png" alt="Café 10" class="cafe-imgc"
                onclick="openModal('Café 10', 'Cold Brew', '3.75', 'El cold brew es un café preparado con agua fría durante varias horas.')">
        </div>
    ...
    <div id="myModal" class="modal">
        <div class="modal-content">
            <table>
                <tD id="tableimg">
                    <img src="../img/cafepng.png" alt="" style="width: 140px;">
                </td>
                <td id="tablespan">
